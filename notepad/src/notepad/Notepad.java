...
{
JOptionPane.showMessageDialog(Notepad.this.f,aboutText,"Javapad!",JOptionPane.INFORMATION_MESSAGE);
}
else
...
final String aboutText=
	...
	+"<p align=right>Developed by Amit Kumar !"
	+"<hr><p align=left>I Used Netbeans IDE 8.2 to develop javapad.<br><br>"
	+"<strong>Thank for using Javapad</strong><br>"
	+"Your Comments as well as bug reports are very welcome at<p align=center>"
	+"<hr><em><big>amitbaghel0341@gmail.com</big></em><hr><html>";
}